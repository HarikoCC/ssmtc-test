...
@Ltb21:
	...
	or	 r12,r0,r11
@L2450:
	bcnd.n	 ne0,r12,@L2449
	or	 r2,r0,r24
	or	 r12,r0,0
	or	 r13,r0,0
	br.n	 @L2719
	or.u	 r11,r0,hi16(_value.246)
	align	 4
@L2449:
	or	 r4,r0,1
	...
	or	 r5,r0,1
	or.u	 r25,r0,hi16(_value.246)
	or	 r3,r3,lo16(@LC131)
	bsr.n	 _lsame_
	st.d	 r12,r25,lo16(_value.246)
	bcnd	 eq0,r2,@L2454
	ld	 r24,r0,r23
	or	 r13,r0,1
	or.u	 r11,r0,hi16(_j.243)
	cmp	 r12,r13,r24
	bb0.n	 le,r12,@L2451
	st	 r13,r11,lo16(_j.243)
	or	 r1,r0,r11
	or.u	 r2,r0,hi16(_i__.242)
	or	 r23,r0,1
	or	 r5,r0,r25
@L2458:
	ld	 r10,r1,lo16(_j.243)
	ld	 r12,r0,r21
	subu	 r11,r10,1
	cmp	 r13,r12,r11
	bb0.n	 gt,r13,@L2459
...
@L2459:
	...
	cmp	 r13,r23,r12
	bb1.n	 gt,r13,@L2457
	st	 r23,r2,lo16(_i__.242)
	or	 r3,r0,r12
	mul	 r4,r10,r19
@L2463:
	ld	 r13,r2,lo16(_i__.242)
	addu	 r13,r13,r4
	ld.d	 r10,r22[r13]
	ld.d	 r6,r5,lo16(_value.246)
	fcmp.sds r13,r10,r0
	or	 r8,r0,r10
	bb1.n	 ge,r13,@L2464
	or	 r9,r0,r11
...
@L2464:
	fcmp.sdd r13,r6,r8
	bb1	 lt,r13,@L2465
	ld.d	 r16,r5,lo16(_value.246)
	br.n	 @L2462
	st.d	 r16,r5,lo16(_value.246)
	align	 4
@L2465:
	st.d	 r8,r5,lo16(_value.246)
@L2462:
	ld	 r13,r2,lo16(_i__.242)
	addu	 r13,r13,1
	cmp	 r12,r13,r3
	bb1.n	 le,r12,@L2463
	st	 r13,r2,lo16(_i__.242)
@L2457:
	ld	 r13,r1,lo16(_j.243)
	addu	 r13,r13,1
	cmp	 r12,r13,r24
	bb1.n	 le,r12,@L2458
	st	 r13,r1,lo16(_j.243)
	br	 @L2451
	align	 4
@L2454:
	ld	 r24,r0,r23
...
@L2473:
	...
	cmp	 r12,r13,r11
	bb1.n	 gt,r12,@L2472
	st	 r13,r3,lo16(_i__.242)
	or	 r2,r0,r11
	mul	 r4,r10,r19
@L2477:
	ld	 r13,r3,lo16(_i__.242)
	addu	 r13,r13,r4
	ld.d	 r10,r22[r13]
	ld.d	 r6,r5,lo16(_value.246)
	fcmp.sds r13,r10,r0
...
@L2484:
	...
	bb0.n	 le,r12,@L2451
	st	 r13,r11,lo16(_j.243)
	or.u	 r4,r0,hi16(_i__.242)
	or	 r1,r0,r11
	or	 r5,r0,r25
@L2503:
	ld	 r11,r0,r21
	ld	 r12,r1,lo16(_j.243)
	st	 r11,r31,88
	cmp	 r13,r12,r11
	bb1.n	 gt,r13,@L2502
	st	 r12,r4,lo16(_i__.242)
	or	 r2,r0,r11
	mul	 r3,r12,r19
@L2507:
	ld	 r13,r4,lo16(_i__.242)
	addu	 r13,r13,r3
	ld.d	 r10,r22[r13]
	ld.d	 r6,r5,lo16(_value.246)
	fcmp.sds r13,r10,r0
...
@L2515:
	...
	or	 r4,r0,1
	or	 r5,r0,1
	or.u	 r20,r0,hi16(_value.246)
	or.u	 r3,r0,hi16(@LC134)
	or.u	 r25,r0,hi16(_udiag.245)
	or	 r3,r3,lo16(@LC134)
	bsr.n	 _lsame_
	st.d	 r12,r20,lo16(_value.246)
	st	 r2,r25,lo16(_udiag.245)
	or	 r2,r0,r18
	or	 r4,r0,1
	...
	bb0.n	 le,r12,@L2451
	st	 r13,r11,lo16(_j.243)
	ld	 r25,r25,lo16(_udiag.245)
	or	 r2,r0,r11
	or.u	 r5,r0,hi16(_sum.247)
	or.u	 r4,r0,hi16(_i__.242)
	or	 r1,r0,r20
	or	 r3,r0,1
	or	 r23,r1,lo16(_value.246)
@L2520:
	bcnd	 eq0,r25,@L2521
	ld	 r13,r0,r21
	ld	 r11,r2,lo16(_j.243)
	cmp	 r13,r11,r13
	bb1	 gt,r13,@L2521
	or.u	 r12,r0,0x3ff0
	or	 r13,r0,0
	st.d	 r12,r5,lo16(_sum.247)
	subu	 r12,r11,1
	st	 r12,r31,88
	cmp	 r13,r3,r12
	bb0.n	 le,r13,@L2529
	st	 r3,r4,lo16(_i__.242)
	or	 r8,r0,r12
	mul	 r9,r11,r19
@L2525:
	ld	 r13,r4,lo16(_i__.242)
...
@L2529:
	...
	or	 r9,r0,r7
@L2538:
	ld	 r13,r2,lo16(_j.243)
	addu	 r13,r13,1
	st.d	 r8,r0,r23
	cmp	 r12,r13,r24
	bb1.n	 le,r12,@L2520
	st	 r13,r2,lo16(_j.243)
	br	 @L2451
	align	 4
@L2516:
	ld	 r24,r0,r23
	...
	bb0.n	 le,r12,@L2451
	st	 r13,r11,lo16(_j.243)
	ld	 r1,r25,lo16(_udiag.245)
	or.u	 r5,r0,hi16(_sum.247)
	or.u	 r4,r0,hi16(_i__.242)
	or	 r2,r0,r20
	or	 r3,r0,r11
	or	 r25,r2,lo16(_value.246)
@L2545:
	bcnd	 eq0,r1,@L2546
	ld	 r10,r3,lo16(_j.243)
	or.u	 r12,r0,0x3ff0
	or	 r13,r0,0
	st.d	 r12,r5,lo16(_sum.247)
	ld	 r11,r0,r21
...
@L2554:
	...
	or	 r9,r0,r7
@L2562:
	ld	 r13,r3,lo16(_j.243)
	addu	 r13,r13,1
	st.d	 r8,r0,r25
	cmp	 r12,r13,r24
	bb1.n	 le,r12,@L2545
	st	 r13,r3,lo16(_j.243)
	br	 @L2451
	align	 4
@L2514:
	or	 r4,r0,1
	or.u	 r3,r0,hi16(@LC136)
	or	 r5,r0,1
	bsr.n	 _lsame_
	or	 r3,r3,lo16(@LC136)
	bcnd.n	 eq0,r2,@L2566
	...
	ld	 r24,r0,r21
	or	 r13,r0,1
	or.u	 r11,r0,hi16(_i__.242)
	cmp	 r12,r13,r24
	bb0.n	 le,r12,@L2570
	st	 r13,r11,lo16(_i__.242)
	or.u	 r8,r0,0x3ff0
	or	 r9,r0,0
@L2572:
	ld	 r13,r11,lo16(_i__.242)
	addu	 r12,r13,1
	st.d	 r8,r25[r13]
	cmp	 r13,r12,r24
	bb1.n	 le,r13,@L2572
	st	 r12,r11,lo16(_i__.242)
@L2570:
	ld	 r24,r0,r23
	or	 r13,r0,1
	or.u	 r11,r0,hi16(_j.243)
...
@L2578:
	...
	cmp	 r13,r2,r12
	bb1.n	 gt,r13,@L2576
	st	 r2,r4,lo16(_i__.242)
	or	 r5,r0,r12
	mul	 r6,r10,r19
@L2582:
	ld	 r7,r4,lo16(_i__.242)
	addu	 r13,r7,r6
	ld.d	 r10,r22[r13]
	fcmp.sds r13,r10,r0
	ld.d	 r8,r25[r7]
...
@L2621:
	...
	cmp	 r12,r13,r11
	bb1.n	 gt,r12,@L2620
	st	 r13,r5,lo16(_i__.242)
	or	 r4,r0,r11
	mul	 r6,r10,r19
@L2625:
	ld	 r7,r5,lo16(_i__.242)
	addu	 r13,r7,r6
	ld.d	 r10,r22[r13]
	fcmp.sds r13,r10,r0
	ld.d	 r8,r25[r7]
...
@L2733:
	...
	or	 r8,r0,r11
@L2651:
	ld	 r13,r8,lo16(_i__.242)
	ld.d	 r10,r9,lo16(_value.246)
	ld.d	 r6,r25[r13]
	fcmp.sdd r13,r10,r6
	bb1	 lt,r13,@L2652
	ld.d	 r16,r9,lo16(_value.246)
	br.n	 @L2650
	st.d	 r16,r9,lo16(_value.246)
	align	 4
@L2652:
	st.d	 r6,r9,lo16(_value.246)
@L2650:
	ld	 r13,r8,lo16(_i__.242)
	addu	 r13,r13,1
	cmp	 r12,r13,r24
	bb1.n	 le,r12,@L2651
	st	 r13,r8,lo16(_i__.242)
	br	 @L2451
	align	 4
@L2566:
	or	 r2,r0,r24
	or	 r4,r0,1
	or.u	 r3,r0,hi16(@LC140)
	or	 r5,r0,1
	bsr.n	 _lsame_
	or	 r3,r3,lo16(@LC140)
	bcnd.n	 ne0,r2,@L2737
...
@L2737:
	...
	or	 r3,r3,lo16(@LC143)
	bcnd.n	 eq0,r2,@L2659
	or.u	 r13,r0,hi16(_scale.244)
	or.u	 r10,r0,0x3ff0
	or	 r11,r0,0
	st.d	 r10,r13,lo16(_scale.244)
	ld	 r12,r0,r21
	ld	 r11,r0,r23
	cmp	 r13,r12,r11
	bb0.n	 gt,r13,@L2660
	or.u	 r10,r0,hi16(_sum.247)
	or	 r12,r0,r11
@L2660:
	flt.ds	 r12,r12
	st.d	 r12,r10,lo16(_sum.247)
	ld	 r24,r0,r23
	or	 r13,r0,2
	or.u	 r11,r0,hi16(_j.243)
	cmp	 r12,r13,r24
...
@L2665:
	...
	addu	 r2,r31,88
	or.u	 r4,r0,hi16(_c__1)
	or.u	 r5,r0,hi16(_scale.244)
	or.u	 r6,r0,hi16(_sum.247)
	or	 r4,r4,lo16(_c__1)
	mak	 r3,r3,0<3>
	or	 r5,r5,lo16(_scale.244)
	addu	 r3,r3,8
	or	 r6,r6,lo16(_sum.247)
	bsr.n	 _dlassq_
	addu	 r3,r22,r3
	ld	 r13,r25,lo16(_j.243)
	addu	 r13,r13,1
	cmp	 r12,r13,r24
	bb1.n	 le,r12,@L2664
	st	 r13,r25,lo16(_j.243)
	br.n	 @L2738
	or.u	 r13,r0,hi16(_sum.247)
	align	 4
@L2659:
	or	 r12,r0,0
	or	 r13,r0,0
	or.u	 r11,r0,hi16(_scale.244)
	st.d	 r12,r11,lo16(_scale.244)
	or.u	 r11,r0,hi16(_sum.247)
	or.u	 r12,r0,0x3ff0
	or	 r13,r0,0
	st.d	 r12,r11,lo16(_sum.247)
	ld	 r24,r0,r23
	or	 r13,r0,1
	or.u	 r11,r0,hi16(_j.243)
	cmp	 r12,r13,r24
...
@L2674:
	or.u	 r13,r0,hi16(_sum.247)
@L2738:
	ld.d	 r2,r13,lo16(_sum.247)
	bsr.n	 _sqrt
	or.u	 r25,r0,hi16(_scale.244)
	ld.d	 r12,r25,lo16(_scale.244)
	or.u	 r11,r0,hi16(_value.246)
	fmul.ddd r12,r12,r2
@L2719:
	st.d	 r12,r11,lo16(_value.246)
@L2451:
@Lte21:
	ld	 r1,r31,80
	ld.d	 r24,r31,72
	ld.d	 r22,r31,64
	ld.d	 r20,r31,56
	or.u	 r13,r0,hi16(_value.246)
	ld.d	 r18,r31,48
	ld.d	 r2,r13,lo16(_value.246)
	ld.d	 r16,r31,40
	jmp.n	 r1
	addu	 r31,r31,96
